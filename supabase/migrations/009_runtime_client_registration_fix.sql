-- Fix PostgreSQL ambiguity between OUT parameter names and runtime_clients columns.
...
begin
  ...
  on conflict on constraint runtime_clients_client_name_key do update
  set key_hash = excluded.key_hash,
      ...
      last_used_at = null,
      updated_at = now()
  returning runtime_clients.id into v_id;
